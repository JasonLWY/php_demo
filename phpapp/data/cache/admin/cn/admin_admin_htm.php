...
<div id="header" class="header">
   ...
   <div class="login">
        ...
        <div id="Header_Member_Item">
            ...
            <div id="Header_Member_Menu" class="header_member_menu">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)" id="MemberMenu" class="default" title="用户管理"><?php echo $this->username; ?>(<?php echo $grouparray['name_phpapp']; ?>)</a></li>
            ...
            <div id="MemberMenuView" class="header_member_default member_menu_list">
                <ul>  
                     ...
                     <li><a href="<?php echo SURL; ?>" target="_blank" title="访问网站首页">[网站首页]</a></li>
       ...
       <p>您好<?php echo $grouparray['name_phpapp']; ?>, <a href="space.php?app=8&uid=<?php echo $this->uid; ?>" target="_blank" title="<?php echo $this->username; ?><?php echo $grouparray['name_phpapp']; ?>"><span class="manage_user"><?php echo $this->username; ?></span></a> </p>
       <p><a href="javascript:;" onclick="$('#ManageAllow').dialog('open');" title="查看我的管理权限">[管理权限]</a> <a href="<?php echo SURL; ?>" target="_blank" title="访问网站首页">[网站首页]</a> <a href="index.php?app=2&action=10" title="安全退出">[退出]</a></p>
       
       </div>
       -->
       <div id="ManageAllow" class="manageallow" style="display:none" title="<?php echo $grouparray['name_phpapp']; ?>管理权限列表">
