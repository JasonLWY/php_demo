...
{ 
    ...
    { 
        $this->oauth = new NetWeiboOAuth( $akey , $skey , $accecss_token , $accecss_token_secret ); 
    } 
     ...
     * @return array 
     */ 
    function update( $text,$source ="<a href=\"http://t.177wan.com\">177wan应用试验基地</a>" ) 
    { 
     ...
     * @return array 
     */ 
    function upload( $text, $pic_path,$source ="<a href=\"http://t.177wan.com\">177wan应用试验基地</a>"  ) 
    { 
      $param = array(); 
      $param['pic'] = "@".$pic_path;
