...
class TaskGrabAutoControls extends TaskGrabMainControls{
	...
	function EndServiceDefaultTop(){
		   ...
		   $smsarr=array(	  
					  ...
					  'sms_msgtoid'=>0,
					  'sms_mailbox'=>'1',
					  'sms_subject'=>'您的'.$this->runarray['tid'].'号任务'.$topname.'推荐服务已过期!',
					  'sms_content'=>'您的'.$this->runarray['tid'].'号任务'.$topname.'推荐服务已过期,<a href="index.php?app='.$this->runarray['app'].'&action=5&tid='.$this->runarray['tid'].'" target="_blank">查看任务</a>',
				 );	
